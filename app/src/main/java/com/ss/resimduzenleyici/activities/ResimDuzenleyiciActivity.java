...
public class ResimDuzenleyiciActivity extends Activity {
    ...
    private void setupViews() {
        ...
        txtVersion.setText("versiyon " + verName + " beta");
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case AppConstants.CHOOSE_PHOTO_REQUEST_CODE:
                    ...
                    Intent editor = new Intent(ResimDuzenleyiciActivity.this, EditPreviewActivity.class);
                ...
                case AppConstants.CAMERA_TAKE_A_PICTURE:
                    ...
                    Intent edtor = new Intent(ResimDuzenleyiciActivity.this, EditPreviewActivity.class);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btnCapture:
                    ...
                    break;
                case R.id.btnFrames:
                    Toast.makeText(ResimDuzenleyiciActivity.this, "Dahil Edilemedi", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
