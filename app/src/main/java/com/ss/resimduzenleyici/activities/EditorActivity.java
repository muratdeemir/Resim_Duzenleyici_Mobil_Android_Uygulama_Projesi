...
import com.ss.resimduzenleyici.adapters.EditorListToolsAdapter;
import com.ss.resimduzenleyici.asynctasks.DoTransformationAsyncTask;
import com.ss.resimduzenleyici.asynctasks.EditorSaveResultAsyncTask;
import com.ss.resimduzenleyici.asynctasks.OpenBitmapAsyncTask;
import com.ss.resimduzenleyici.imageprocessing.AbstractOptimizeTransformation;
...
import com.ss.resimduzenleyici.utils.ViewUtils;
...
public class EditorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BuildConfig.DEBUG) {
            GLog.v("Düzenleyici Seçilen Resim", selectedPhoto);
        }
            ...
            switch (v.getId()) {
                case R.id.btnApply:
                    if (toolContainer.getDisplayedChild() != BASE_TOOL_PANEL && editorState.equals(EditorState.APPLYABLE)) {
                        ...
                        GLog.v("Düzenleyici", "Tamamlanabilir");
                        //DONE PRESSED
                ...
                case R.id.btnBack:
                    AlertDialog confirm = new AlertDialog.Builder(EditorActivity.this)
                            .setMessage("Düzenleyiciden çıkmak istediğinize eminmisiniz?")
